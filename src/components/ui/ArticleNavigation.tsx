      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:items-stretch">
        ...
        <div className="flex">
          {previous ? (
            <Link
              ...
              className="group flex-1 flex flex-col rounded-lg border border-white/20 bg-white/5 p-4 transition-colors hover:bg-white/10"
            >
            ...
            <Link
              ...
              className="group flex-1 flex flex-col rounded-lg border border-white/20 bg-white/5 p-4 transition-colors hover:bg-white/10"
            >
              <div className="text-xs text-zinc-400 mb-3">View All</div>
        ...
        <div className="flex">
          {next ? (
            ...
            <Link
              href={viewAllPath}
              className="group flex-1 flex flex-col rounded-lg border border-white/20 bg-white/5 p-4 text-right transition-colors hover:bg-white/10"
            >
              <div className="text-xs text-zinc-400 mb-3">View All</div>
